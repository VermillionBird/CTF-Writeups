...
if __name__ == '__main__':
    ...
    parser.add_argument('Number', help='The number to find the inverse of',metavar='NUMBER',type=int)
    parser.add_argument('Modulus', help='The modulus',metavar='MODULUS',type=int)
